...
function createToken(usuario) {
    return jsonwebtoken_1.default.sign({ uuid: usuario.uuid, username: usuario.username, rol: usuario.rol }, config_1.default.jwtSecret, {
        // expiresIn: 86400
        expiresIn: '12h'
    });
}
...
function login(req, res, next) {
    return __awaiter(this, void 0, void 0, function* () {
        try {
            ...
            if (isMatch) {
                const { nombre, apellidoPaterno, apellidoMaterno, rol } = usuario[0];
